...
const Checkout = () => {
  ...
  const { totalPrice, apartmentId, evaluatedNights } = location.state || {};

  const singleId = data.filter((mydata) => mydata.id == apartmentId);
  ...
  let priceWithTax = singleId[0].price * 1.14;
