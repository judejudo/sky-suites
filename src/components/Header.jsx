...
const Navbar = ({ textColour }) => {
  ...
  return (
    <nav className={`fixed font-luxjost md:flex top-0 p-4 z-20 w-full transition-all duration-300 ${isBlurred ? 'backdrop-blur bg-orange-100/50 text-orange' : 'bg-transparent text-white '}`}>
